...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .tab-btn:hover:not(.active) { background: #f6f6f6; }
        ...
        .nav-link { color: #9ca3af; text-decoration: none; font-size: 0.85rem; padding: 6px 10px; transition: all 0.3s ease; }
...
<body>
        ...
        <div style="width:100%;max-width:400px;">
            ...
            <div class="card">
                ...
                <div id="loginForm">
                    <form onsubmit="return false;">
                        <div style="margin-bottom:16px;">
                            <input type="email" id="loginEmail" class="form-input" placeholder="Email address" autocomplete="email" />
                        </div>
                        <div style="margin-bottom:16px;">
                            <input type="password" id="loginPassword" class="form-input" placeholder="Password" autocomplete="current-password" />
                        </div>
                        <div style="text-align:right;margin-bottom:16px;">
                            <button type="button" id="forgotPasswordBtn" style="background:none;border:none;color:#024ddf;font-size:14px;cursor:pointer;">Forgot password?</button>
                        </div>
                ...
                <div id="signupForm" style="display:none;">
                    <form onsubmit="return false;">
                        <div style="margin-bottom:16px;">
                            <input type="text" id="signupName" class="form-input" placeholder="Full name" autocomplete="name" />
                        </div>
                        <div style="margin-bottom:16px;">
                            <input type="email" id="signupEmail" class="form-input" placeholder="Email address" autocomplete="email" />
                        </div>
                        <div style="margin-bottom:16px;">
                            <input type="password" id="signupPassword" class="form-input" placeholder="Create password (min 6 chars)" autocomplete="new-password" />
                        </div>
                        <div style="margin-bottom:16px;">
                ...
                <div style="space-y:12px;">
                    <button id="googleBtn" style="display:flex;align-items:center;justify-content:center;gap:10px;width:100%;padding:12px;border-radius:4px;border:1px solid #bfbfbf;background:#fff;color:#121212;cursor:pointer;font-weight:500;min-height:44px;">
                        <i class="fab fa-google" style="color:#ea4335;"></i> Continue with Google
                    </button>
                    <button id="facebookBtn" style="display:flex;align-items:center;justify-content:center;gap:10px;width:100%;padding:12px;border-radius:4px;border:1px solid #bfbfbf;background:#fff;color:#121212;cursor:pointer;font-weight:500;min-height:44px;">
    ...
    <div id="forgotModal" style="display:none;position:fixed;inset:0;z-index:50;background:rgba(0,0,0,0.6);backdrop-filter:blur(4px);align-items:center;justify-content:center;padding:16px;">
        <div style="background:#fff;border-radius:4px;max-width:400px;width:100%;padding:24px;position:relative;box-shadow:0 20px 60px rgba(0,0,0,0.3);">
            <button id="closeForgotBtn" style="position:absolute;top:16px;right:16px;background:none;border:none;font-size:24px;color:#646464;cursor:pointer;">✕</button>
            ...
            <div style="margin-bottom:16px;">
                <input type="email" id="resetEmail" class="form-input" placeholder="Email address" autocomplete="email" />
            </div>
    ...
    <!-- ======================================== -->
    <!-- JAVASCRIPT - USE FUNCTIONS FROM supabase.js -->
    <!-- ======================================== -->
    <script>
        // ============================================================
        // DO NOT DECLARE supabase HERE - IT'S IN supabase.js
        // ============================================================
        ...
        setTimeout(function() {
            if (typeof signUp !== 'undefined') {
                console.log('✅ signUp function is available from supabase.js');
            } else {
                console.error('❌ signUp function NOT found!');
                console.log('⚠️ Make sure js/supabase.js is loaded correctly');
            }
        }, 500);
        ...
        async function handleLogin() {
            ...
            loginBtn.innerHTML = '<span class="spinner mr-2"></span> Signing In...';
            
            try {
                // Use signIn from supabase.js
        ...
        async function handleSignup() {
            ...
            signupBtn.innerHTML = '<span class="spinner mr-2"></span> Creating Account...';
            
            try {
                // Use signUp from supabase.js
        ...
        function socialLogin(provider) {
            ...
            // Use supabase from the global scope (from supabase.js)
        ...
        googleBtn.addEventListener('click', function() { socialLogin('google'); });
        facebookBtn.addEventListener('click', function() { socialLogin('facebook'); });
        ...
        document.addEventListener('DOMContentLoaded', function() {
            console.log('💡 Ready! Click Sign Up to create an account.');
